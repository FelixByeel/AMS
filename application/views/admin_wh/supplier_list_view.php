...
<div class = "content-wrapper">
    <p class = "con-title">
        <?php echo isset($con_title) ? $con_title : '供货商列表' ?>
    </p>
    <div class = "content">
        <div class = "action-header">
            <span class = "link-header">
                <a class = "action-link" href="<?php echo site_url() . '/admin_wh/supplier/add'; ?>">添加供货商</a>
            </span>
        </div>
        <div class = "supplier-list">
            <table class = "layui-table fixed-table">
                ...
                foreach ($result as $key => $value) {
                    ...
                    echo '<a class = \'action-link\' href = ' . site_url() . '/admin_wh/supplier/edit/' . $value['sid'] .
                            (empty($this->uri->segment(4)) ? '' : '/' . $this->uri->segment(4)) . '>编辑</a>';

                    echo '<a class = \'action-link layui-bg-red\' href = ' . site_url() . '/admin_wh/supplier/del/' . $value['sid']  .
