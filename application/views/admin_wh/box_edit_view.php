...
<div class = "content-wrapper">
    <p class = "con-title">
        <?php echo isset($con_title) ? $con_title : '编辑储物柜'; ?>
    </p>
    <div class = "content">
        <div class = "box-edit">
            <form class="layui-form" action = "<?php echo site_url() . '/admin_wh/box/edit_do/' . $result[0]['bid'] . (empty($page) ? '' : '/' . $page); ?>" method = "POST">
                ...
                <table class = "layui-table fixed-table">
                    <tr>
                        <td>请输入储物柜名称：</td>
                        <td>
                            <input autocomplete="off" class="layui-input" required lay-verify="required" type="text" name="box-name" maxlength = "20" value = "<?php echo $result[0]['box_name']; ?>">
                        </td>
                        <td>
