...
<div class = "content-wrapper">
    <p class = "con-title">
        <?php echo isset($con_title) ? $con_title : '编辑仓库' ?>
    </p>
    <div class = "content">
        <div class = "wh-edit">
            <form class="layui-form" action = "<?php echo site_url('/admin/warehouse/edit_do/' . $result[0]['wid']); ?>" method = "POST">
                ...
                <table class="layui-table fixed-table">
                    <tr>
                        <td>请输入仓库名称：</td>
                        <td>
                            <input autocomplete="off" class="layui-input" required lay-verify="required" type="text" name="wh-name" maxlength = "20" value = "<?php echo $result[0]['warehouse_name']; ?>">
                        </td>
                        <td>
