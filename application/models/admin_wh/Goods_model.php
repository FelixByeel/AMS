...
class Goods_model extends CI_Model
{
    ...
    */
    public function search($condition = array(), $limit = 0, $offset = 0)
    {
        ...
        $this->db->join('warehouse', 'goods.wid = warehouse.wid', 'left');
    ...
    */
    public function update($data = array(), $condition = array())
    {
        ...
        if (empty($data) || !isset($condition['gid'])) {
            $status['code'] = -1;
            $status['msg'] = '无效数据！';
    ...
    */
    public function del($condition = array())
    {
        ...
        if (!isset($condition['gid']) || empty($this->search($condition))) {
            $status['code'] = -1;
            $status['msg'] = '无效数据！';
